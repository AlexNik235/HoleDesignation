        ...
        string outputDirectory)
    {
        ...
        if (!addInTypesPerProjects.Any())
        {
            throw new ArgumentException(
                $"Project {rootProjectName} should contain any {Constants.Cmd} or {Constants.AppCmd} type!");
        }
        ...
        string output)
    {
        ...
        foreach (var addinTypesPerProject in addinTypesPerProjects)
        {
            ...
            addIns.Add(new AddIn(
                ...
                assemblyType.PluginType.Ensure().ToPluginType()));
        }
